...
elements in the ith row and colSum[j] is the sum of the elements of the jth column of a 2D matrix. 
...
/*
        ...
        as only 2n equations are there.
        2. take the 1st row and 1st column sum , the intersecting point is to be taken as the minimum of the two
        sums. Fill the rest of the row/col by zeros depending on which is smaller. 
        3. Adjust 
