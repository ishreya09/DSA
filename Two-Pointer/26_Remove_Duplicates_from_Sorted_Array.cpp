...
1. initialize i as starting point of a number and j as end point of that same number
2. Delete all the occurence of i until i becomes equal to j using erase(Remember that index gets changed each time
so we do not increment i)
3. increment i for another number
