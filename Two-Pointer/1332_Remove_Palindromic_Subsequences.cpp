...
1. subsequence of "abc" is "a","b","c","ac","ab","bc","abc". The order matters but string to be picked need 
not be continous (intermittently).
Substrings are continous. 
2. So the answer will be 1 when the whole string is palindrome
3. Otherwise it will take 2 operations - one to delete all a's and then another to delete all b's.
