...
1. Initialise start as 0 and end as end of array
2. Find the max element and then reverse the array from start to the max element's index
3. Now reverse the whole array from start to end, making the maximum element to come at the end of the array
and we decrement the end and repeat it until the array is sorted.
