...
1. Allocate a pointer to the first element of the vector and traverse the array
2. Go on erasing the values from the array and remember to drcrement the value of i 
so that we stay at same position to check for the next number that came to the index i now.
