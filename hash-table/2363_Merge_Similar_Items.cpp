...
1. push items1 and items2 elements in the same map with val as key and weight as value
2. return the ans as 2D vector by pushing all the map's value back into the vector.
