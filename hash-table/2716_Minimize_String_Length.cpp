...
1. Take a map for checking if a character is already present or not
2. If yes- then erase that character using string:: erase(iterator) function
3. s.begin()+i points to the iterator we want to erase and decrement i as i points to the
old i+1 index and we do i-- to fix it.
