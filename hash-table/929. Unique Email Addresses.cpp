...
will be forwarded to the same address without dots in the local name. Note that this 
...
1. Write a func sendEmailto- which accepts the string and returns actual email address where the email is sent to
2. Do inplace change in s and store the freq of those in a map
3. The size of map is the no of unique emails in emails array.  
